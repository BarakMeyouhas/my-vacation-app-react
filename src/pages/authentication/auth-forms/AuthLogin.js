...
// material-ui
import { Button, Box, FormHelperText, Grid, Link, IconButton, InputAdornment, InputLabel, OutlinedInput, Stack } from '@mui/material';
...
const AuthLogin = () => {
  ...
  const loginAsAdmin = () => {
    ...
    localStorage.setItem('user_email', 'admin1@gmail.com');
